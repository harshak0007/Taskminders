	...
	return (
		<DayPicker
			...
			classNames={{
				...
				cell: 'h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md :rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 dark:[&:has([aria-selected].day-outside)]:bg-zinc-800/50 dark:[&:has([aria-selected])]:bg-zinc-800',
				day: cn(
				...
				day_selected:
					'text-zinc-900 rounded-full bg-[#f6c76c] dark:text-zinc-50',
				day_today: 'text-zinc-900 rounded-full bg-[#f6c76c] dark:text-zinc-50',
				day_outside:
